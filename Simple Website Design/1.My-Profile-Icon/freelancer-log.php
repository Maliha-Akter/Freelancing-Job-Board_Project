...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    if (isset($_POST['register'])) {
        ...
        if ($getEmailResult && mysqli_num_rows($getEmailResult) > 0) {
          ...
          $query = "INSERT INTO freelancer (user_id, username, password, email) VALUES ('$userId', '$username', '$password', '$email')";
       ...
       elseif (isset($_POST['login'])) {
        ...
        $query = "SELECT * FROM freelancer WHERE user_id='$userId' AND username='$username' AND password='$password'";
        $result = mysqli_query($con, $query);
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          $_SESSION['user_id'] = $freelancer_id;

            // echo "Login successful!";
            header("location: apply-for-job-freelancer.php");
            die;
        } else {
  ...
  <div class="container" id="main">
    <div class="sign-up">
      <form action="#" method="post">
        <h1>Create Account As Freelancer</h1>
